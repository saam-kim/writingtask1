...
export const level4Questions: Question[] = [
  ...
  },
  {
    ...
    sentenceTemplate: "Not only _____ _____ _____ _____ also grants me a scholarship.",
    chunks: ["does the", "university waive", "my fees,", "but it", "the university", "waives my", "but they"],
    answer: ["does the", "university waive", "my fees,", "but it"],
    explanation: "The correct sentence is: 'Not only does the university waive my fees, but it also grants me a scholarship.'",
    koreanExplanation: "대학은 내 등록금을 면제해 줄 뿐만 아니라 장학금도 지급합니다. 'Not only'로 시작하는 문장에서 조동사 'does'와 주어 'the university'가 도치되어 나타나며, 'but it also' 뒤에 동사 'grants'가 이어지는 어순입니다.",
