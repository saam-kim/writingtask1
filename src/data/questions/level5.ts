...
export const level5Questions: Question[] = [
  ...
  },
  {
    ...
    sentenceTemplate: "Were the university _____ _____ _____ _____ _____ student body.",
  ...
  },
  {
    ...
    sentenceTemplate: "The department integrated _____ _____ _____ _____ _____ work efficiency.",
    chunks: ["the updated", "database system", "thereby reducing", "time spent", "on sorting", "integrate", "there", "sorted", "spent of", "sorting to"],
    answer: ["the updated", "database system", "thereby reducing", "time spent", "on sorting"],
    explanation: "The correct sentence is: 'The department integrated the updated database system, thereby reducing time spent on sorting work efficiency.'",
